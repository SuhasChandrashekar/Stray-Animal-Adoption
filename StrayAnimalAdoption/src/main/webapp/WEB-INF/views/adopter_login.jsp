...
<body class="bg-info">
	...
	<h1 class="page-header text-center">Login - Adopter</h1>
	<FORM ACTION="${contextPath}/user/loginAsAdopter" METHOD="POST" class="form-inline text-center">
		<TABLE class="text-center">
			...
			<br><br>
			<a href="${contextPath}/user/signup.htm">sign up as new adopter!</a>
			&nbsp;&nbsp;&nbsp;
			<a href="${contextPath}/user/loginAsEmployee.htm">Login as employee</a>
		</TABLE>
	</FORM>
</body>
</html>